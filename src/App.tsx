...
function App() {
  // Use the correct path structure for GitHub Pages
  // For GitHub Pages, the base path is the repository name
  const repoName = 'WebDevPortfolio'; // Replace with your actual repo name
  
  const portfolioItems = [
    {
      title: "BoostupMedia",
      image: `/${repoName}/images/WD6.png`,
      url: "https://boostupmedia.in/"
    },
    {
      title: "DGineers",
      image: `/${repoName}/images/WD1.png`,
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Vertical Navigation - Preserved design with responsive spacing */}
      <nav className="fixed left-0 top-0 h-full flex items-center z-50 px-1 sm:px-2 md:px-4">
        <div className="flex flex-col space-y-4 sm:space-y-6 md:space-y-8 py-4 px-2 backdrop-blur-sm bg-white/30 rounded-r-lg shadow-md">
          {['home', 'about', 'portfolio', 'contact'].map((item, index) => (
            ...
            >
              <div className="flex flex-col items-center transform group-hover:scale-110 transition-transform duration-300">
                <span className="writing-mode-vertical text-xs sm:text-sm md:text-base text-blue-600 group-hover:text-blue-800"
                      style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}>
                  {item.charAt(0).toUpperCase() + item.slice(1)}
                </span>
                <div className="w-1 h-4 sm:h-6 md:h-8 bg-gradient-to-b from-blue-400 to-blue-600 mt-1 transform scale-0 group-hover:scale-100 transition-transform duration-300"></div>
              </div>
            </a>
          ))}
        </div>
      ...
      {/* Main Content - Adjusted for responsive design */}
      <main className="ml-8 sm:ml-12 md:ml-16"> 
        {/* Hero Section */}
        <section id="home" className="min-h-screen relative overflow-hidden bg-gradient-to-r from-blue-50 to-white flex items-center">
          ...
          <div className="container mx-auto px-4 py-8 md:py-16 lg:py-32 relative">
            <div className="flex flex-col items-center text-center">
              <div className="w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 rounded-full overflow-hidden mb-4 sm:mb-6 md:mb-8 animate-float shadow-lg">
                <img 
                  src={`/${repoName}/images/Formal1.jpg`}
                  alt="Profile"
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 sm:mb-4 animate-slideUp bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">Neeraj Madkar</h1>
        ...
        {/* About Section */}
        <section id="about" className="py-10 sm:py-14 md:py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 md:mb-12 text-center animate-scale bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">About Me</h2>
        ...
        {/* Portfolio Section */}
        <section id="portfolio" className="py-10 sm:py-14 md:py-20 bg-blue-50">
          <div className="container mx-auto px-4 sm:px-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 md:mb-12 text-center animate-scale bg-gradient-to-r from-blue-600 to-indigo-600 text-transparent bg-clip-text">My Work</h2>
        ...
        <section id="contact" className="relative">
          <div className="bg-gradient-to-br from-blue-600 to-indigo-800 py-10 sm:py-14 md:py-20">
            <div className="container mx-auto px-4 sm:px-6">
              ...
              <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-8 max-w-4xl mx-auto">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-3 sm:p-4 md:p-6 transform hover:scale-105 transition-all duration-300 group shadow-md"
                >
              ...
              <div className="mt-8 sm:mt-12 md:mt-16 py-4 sm:py-6 md:py-8 px-3 sm:px-4 rounded-t-3xl bg-blue-900/30 backdrop-blur-sm">
